...
<html lang="es">
    ...
    <head>
        ...
        <title>Asignaciones Ordenes de Trabajo</title>
    </head>

    <body>
        <div class="container">
            <h1>Asignaciones Ordenes de Trabajo</h1>
            <div class="row">
                <div class="float-right">
                    <button type="button" class="btn btn-w-m btn-primary"
                        onclick="window.location='{{ route('asignaciones.create') }}'">
