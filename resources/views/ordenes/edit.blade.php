    ...
    <body>
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form action="{{ route('ordenes.update', $orden->id) }}" method="post" autocomplete="off">
                        {{-- Token de seguridad --}}
                        @method('PATCH')
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="tipoTrabajo"
                                                value="Obras Civiles"
                                                {{ old('tipoTrabajo', $orden->tipoTrabajo ?? '') == 'Obras Civiles' ? 'checked' : '' }}>Obras
                                            Civiles
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="tipoTrabajo"
                                                ...
                                                {{ old('tipoTrabajo', $orden->tipoTrabajo ?? '') == 'Obras Eléctricas' ? 'checked' : '' }}>Obras
                                            Eléctricas
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="summernote" name="descripcion" id="descripcion" rows="6"
                                        placeholder="Descripción del tipo de orden de trabajo.">{{ $orden->descripcion }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="summernote" name="observaciones" id="observaciones" rows="6"
                                        placeholder="Observaciones que se encontraron mientras se realizaba la orden de trabajo.">{!! $orden->observacion !!}</textarea>
                                </div>
                                {{-- Precio --}}
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="monto" id="monto" class="form-control precio"
                                            value="{{ $orden->monto }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="tipoEstado"
                                                value="Pendiente"
                                                {{ old('tipoEstado', $orden->tipoEstado ?? '') == 'Pendiente' ? 'checked' : '' }}>Pendiente
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="tipoEstado"
                                                value="Finalizado"
                                                {{ old('tipoEstado', $orden->tipoEstado ?? '') == 'Finalizado' ? 'checked' : '' }}>Finalizado
                                        </label>
                                    </div>
                                </div>
                            </div>
        ...
        {{-- price_format --}}
        <script src="{{ asset('js/plugins/price_format/price_format.2.0.min.js') }}"></script>
